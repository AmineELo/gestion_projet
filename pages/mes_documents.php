...
<div id="page-wrapper">
  <div class="row">
      <div class="col-md-12">
          ...
          Ajouter un nouveau doccument  <button class="btn btn-primary" data-toggle="modal" data-target="#ajoutDoccument"><i class="fa fa-plus-circle"></i> Ajouter</button>
      </div>
      <!-- /.col-lg-12 -->
  </div>
  <br>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="form-horizontal" role="form">
            ...
            <div class="form-group">
              <label  class="col-sm-2 control-label" for="titre">Importer doccument (pdf)</label>
              <div class="col-sm-10">
